...
public class InvalidInstanceExceptionDiffblueTest {
   ...
   * InvalidInstanceException#InvalidInstanceException(IEntityJsonContext, String, Throwable)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void InvalidInstanceException.<init>(IEntityJsonContext)",
  ...
  public void testNewInvalidInstanceException_thenReturnMessageIsAnErrorOccurred() {
    ...
    // Act
    InvalidInstanceException actualInvalidInstanceException =
        new InvalidInstanceException(context, "An error occurred", cause);
   ...
   *
   * <p>Method under test: {@link
   * InvalidInstanceException#InvalidInstanceException(IEntityJsonContext, Throwable)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testNewInvalidInstanceException_thenReturnMessageIsJavaLangThrowable() {
    ...
    // Act
    InvalidInstanceException actualInvalidInstanceException =
        new InvalidInstanceException(context, cause);
   ...
   *
   * <p>Method under test: {@link
   * InvalidInstanceException#InvalidInstanceException(IEntityJsonContext, String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testNewInvalidInstanceException_whenAnErrorOccurred_thenReturnCauseIsNull() {
    ...
    // Act
    InvalidInstanceException actualInvalidInstanceException =
        new InvalidInstanceException(context, "An error occurred");
   ...
   *
   * <p>Method under test: {@link
   * InvalidInstanceException#InvalidInstanceException(IEntityJsonContext)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testNewInvalidInstanceException_whenTrue_thenReturnMessageIsAnErrorOccurred() {
    ...
    // Act
    InvalidInstanceException actualInvalidInstanceException =
        new InvalidInstanceException(context, "An error occurred", cause, true, true);
