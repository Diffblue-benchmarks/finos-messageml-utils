...
public class NoSchemaExceptionDiffblueTest {
   ...
   * </ul>
   * <p>
   * Method under test: {@link NoSchemaException#NoSchemaException(IEntityJsonContext, String)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void NoSchemaException.<init>(IEntityJsonContext)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link NoSchemaException#NoSchemaException(IEntityJsonContext, String, Throwable)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void NoSchemaException.<init>(IEntityJsonContext)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link NoSchemaException#NoSchemaException(IEntityJsonContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void NoSchemaException.<init>(IEntityJsonContext)",
   ...
   * </ul>
   * <p>
   * Method under test: {@link NoSchemaException#NoSchemaException(IEntityJsonContext, Throwable)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void NoSchemaException.<init>(IEntityJsonContext)",
  ...
  /**
   * Test {@link NoSchemaException#NoSchemaException(IEntityJsonContext, String, Throwable, boolean, boolean)}.
   * <ul>
   *   <li>When {@code true}.</li>
   *   <li>Then return Message is {@code An error occurred}.</li>
   * </ul>
   * <p>
   * Method under test: {@link NoSchemaException#NoSchemaException(IEntityJsonContext, String, Throwable, boolean, boolean)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"void NoSchemaException.<init>(IEntityJsonContext)",
