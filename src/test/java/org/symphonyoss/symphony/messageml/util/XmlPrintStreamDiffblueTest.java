...
public class XmlPrintStreamDiffblueTest {
  ...
  public void testOpenElementWithStringMap10() {
    ...
    // Assert
    assertEquals(9L, xmlPrintStream.getOffset());
  }
   ...
   * <ul>
   *   <li>Given {@code >}.
   *   <li>When {@link HashMap#HashMap()} {@code 42} is {@code >}.
   * </ul>
   *
   * <p>Method under test: {@link XmlPrintStream#openElement(String, Map)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void XmlPrintStream.printElement(String, Map)"})
  public void testPrintElementWithElementNameAttributes9() {
    // Arrange
    XmlPrintStream xmlPrintStream = new XmlPrintStream(new ByteArrayOutputStream());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void XmlPrintStream.printElement(String, Map)"})
  public void testPrintElementWithElementNameAttributes10() {
    // Arrange
    XmlPrintStream xmlPrintStream = new XmlPrintStream(new ByteArrayOutputStream());
