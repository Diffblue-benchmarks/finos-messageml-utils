...
public class TableHeaderDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link TableHeader#TableHeader(Element)} with parent is {@link Bold#Bold(Element)}.
  ...
  public void testValidate_givenTableHeaderWithParentIsBold_thenDoesNotThrow()
      throws InvalidInputException {
    // Arrange
    Bold parent = new Bold(new BulletList(null));

    // Act and Assert
    new TableHeader(parent).validate();
  }
