...
public class ButtonDiffblueTest {
   ...
   * {@link Element}.</li>
   *   <li>Then {@link Button#logger} return
   * {@link ch.qos.logback.classic.Logger}.</li>
   * </ul>
   * <p>
  ...
  public void testNewButton_whenBulletListWithParentIsElement_thenLoggerReturnLogger() {
    ...
    // Assert
    assertTrue(actualButton.logger instanceof ch.qos.logback.classic.Logger);
   ...
   * Test {@link Button#asPresentationML(XmlPrintStream, MessageMLContext)}.
   * <ul>
   *   <li>Given {@link Button#Button(Element, FormatEnum)} with parent is
   * {@link Bold#Bold(Element)} and format is {@code PRESENTATIONML}.</li>
   * </ul>
   * <p>
   * Method under test:
   * {@link Button#asPresentationML(XmlPrintStream, MessageMLContext)}
