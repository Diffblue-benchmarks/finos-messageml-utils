...
public class TableFooterDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link TableFooter#TableFooter(Element)} with parent is {@link Bold#Bold(Element)}.
  ...
  public void testValidate_givenTableFooterWithParentIsBold_thenDoesNotThrow()
      throws InvalidInputException {
    // Arrange
    Bold parent = new Bold(new BulletList(null));

    // Act and Assert
    new TableFooter(parent).validate();
  }
