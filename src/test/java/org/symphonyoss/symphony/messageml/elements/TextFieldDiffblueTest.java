...
public class TextFieldDiffblueTest {
  ...
  @MethodsUnderTest({"void TextField.<init>(Element, FormatEnum)", "String TextField.getElementId()",
      "String TextField.getElementType()", "Integer TextField.getMaxValueAllowed()",
      "Integer TextField.getMinValueAllowed()", "String TextField.getPresentationMLTag()"})
   ...
   * <p>
   * Method under test: {@link TextField#buildAll(MessageMLParser, org.w3c.dom.Element)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * Test {@link TextField#buildAll(MessageMLParser, Element)}.
   * <ul>
   *   <li>Then {@link TextField#TextField(Element, FormatEnum)} with parent is {@link Bold#Bold(Element)} and messageFormat is {@code MESSAGEML} size is zero.</li>
   * </ul>
   * <p>
   * Method under test: {@link TextField#buildAll(MessageMLParser, org.w3c.dom.Element)}
   */
   ...
   * Test {@link TextField#buildAll(MessageMLParser, Element)}.
   * <ul>
   *   <li>When {@link MessageMLParser} {@link MessageMLParser#createElement(Element, Element)} return {@link Bold#Bold(Element)} with parent is {@link BulletList#BulletList(Element)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link TextField#buildAll(MessageMLParser, org.w3c.dom.Element)}
   */
