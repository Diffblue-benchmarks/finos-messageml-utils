...
public class HashTagDiffblueTest {
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"String HashTag.getEntitySubType()", "String HashTag.getEntityType()",
      "String HashTag.getEntityVersion()", "String HashTag.getTagPattern()", "String HashTag.toString()"})
