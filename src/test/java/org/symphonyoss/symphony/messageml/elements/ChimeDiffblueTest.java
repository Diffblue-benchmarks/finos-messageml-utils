...
public class ChimeDiffblueTest {
  ...
  public void testBuildAttribute_thenThrowInvalidInputException() throws InvalidInputException {
    ...
    assertThrows(
        ...
        () -> chime.buildAttribute(parser, new IIOMetadataNode("Node Name")));
  }
   ...
   *
   * <ul>
   *   <li>When {@link IIOMetadataNode#IIOMetadataNode(String)} with {@code autoplay}.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Chime.buildAttribute(MessageMLParser, Node)"})
  public void testBuildAttribute_whenIIOMetadataNodeWithAutoplay_thenDoesNotThrow()
      throws InvalidInputException {
    // Arrange
    Chime chime = new Chime(new MessageML(FormatEnum.MESSAGEML, "1.0.2"), FormatEnum.MESSAGEML);
    MessageMLParser parser = mock(MessageMLParser.class);
    ...
    // Act and Assert
    chime.buildAttribute(parser, new IIOMetadataNode("autoplay"));
  }
