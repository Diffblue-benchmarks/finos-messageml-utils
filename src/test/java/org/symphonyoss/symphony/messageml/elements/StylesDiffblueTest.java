...
public class StylesDiffblueTest {
   ...
   * </ul>
   *
   * <p>Method under test: {@link Styles#validate(String)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"void Styles.validate(String)"})
  public void testValidate_whenBase64_thenThrowInvalidInputException()
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Styles.validate(String)"})
  public void testValidate_whenEmptyString_thenDoesNotThrow() throws InvalidInputException {
    // Arrange, Act and Assert
    Styles.validate("");
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Styles.validate(String)"})
  public void testValidate_whenStyleAttribute_thenThrowInvalidInputException()
      throws InvalidInputException {
    // Arrange, Act and Assert
