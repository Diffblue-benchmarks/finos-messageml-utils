...
public class MinMaxLengthElementDiffblueTest {
  ...
  public void testIsMinAndMaxLengthCombinationValid_whenNull_thenReturnFalse() {
    ...
    // Act and Assert
    assertFalse(
        new TextArea(parent2, FormatEnum.MESSAGEML).isMinAndMaxLengthCombinationValid(null, null));
  }
  ...
  public void testIsTextBiggerThanMaxLength_whenNull_thenReturnFalse() {
    ...
    // Act and Assert
    assertFalse(new TextArea(parent2, FormatEnum.MESSAGEML).isTextBiggerThanMaxLength(null, null));
  }
  ...
  public void testIsTextSmallerThanMinLength_whenNull_thenReturnFalse() {
    ...
    // Act and Assert
    assertFalse(new TextArea(parent2, FormatEnum.MESSAGEML).isTextSmallerThanMinLength(null, null));
  }
