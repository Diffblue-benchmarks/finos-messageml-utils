...
public class PersonSelectorDiffblueTest {
  ...
  @MethodsUnderTest({"void PersonSelector.<init>(Element, FormatEnum)", "String PersonSelector.getElementId()",
   ...
   * <p>
   * Method under test: {@link PersonSelector#buildAll(MessageMLParser, org.w3c.dom.Element)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * <p>
   * Method under test: {@link PersonSelector#asPresentationML(XmlPrintStream, MessageMLContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"Node PersonSelector.asMarkdown()"})
