...
public class ItalicDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link Italic#Italic(Element)} with parent is {@link Bold#Bold(Element)}.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void Italic.validate()"})
  public void testValidate_givenItalicWithParentIsBold_thenDoesNotThrow()
      throws InvalidInputException {
    // Arrange
    Bold parent = new Bold(new BulletList(null));

    // Act and Assert
    new Italic(parent).validate();
  }
