...
public class TagDiffblueTest {
   ...
   * <p>
   * Method under test: {@link Tag#asPresentationML(XmlPrintStream, MessageMLContext)}
   */
  @Test
  @Category(MaintainedByDiffblue.class)
   ...
   * Test {@link Tag#asPresentationML(XmlPrintStream, MessageMLContext)}.
   * <ul>
   *   <li>Given {@link Instrument} (default constructor) RootBbgCompTicker is {@code >}.</li>
   * </ul>
   * <p>
   * Method under test: {@link Tag#asPresentationML(XmlPrintStream, MessageMLContext)}
   */
   ...
   * <ul>
   *   <li>Given {@link Tag#Tag(Element, int)} with parent is {@link Bold#Bold(Element)} and entityIndex is one.</li>
  ...
  @Test
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"String Tag.getEntityIdPrefix()", "String Tag.getEntitySubType()", "String Tag.getEntityType()",
      "TagAttributes Tag.getTagAttributes()", "void Tag.setInstrument(Instrument)"})
   ...
   * <ul>
   *   <li>Given {@link Instrument} (default constructor) BbgCompId is {@code 42}.</li>
   ...
   * Test {@link Tag#updateBiContext(BiContext)}.
   * <ul>
   *   <li>Then {@link BiContext} (default constructor) Items third Name is {@code hashtags}.</li>
   * </ul>
   * <p>
   * Method under test: {@link Tag#updateBiContext(BiContext)}
   */
   ...
   *   <li>Then {@link BiContext} (default constructor) Items first Name is {@code hashtags}.</li>
   * </ul>
   * <p>
   * Method under test: {@link Tag#updateBiContext(BiContext)}
   */
