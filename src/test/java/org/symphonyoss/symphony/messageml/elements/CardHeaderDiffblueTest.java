...
public class CardHeaderDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void CardHeader.<init>(Element, FormatEnum)",
    "String CardHeader.getPresentationMLTag()"
  })
   ...
   * </ul>
   *
   * <p>Method under test: {@link CardHeader#buildAttribute(MessageMLParser, org.w3c.dom.Node)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"void CardHeader.buildAttribute(MessageMLParser, org.w3c.dom.Node)"})
  public void testBuildAttribute_whenIIOMetadataNode_thenThrowInvalidInputException()
      throws InvalidInputException {
    // Arrange
    BulletList parent = new BulletList(mock(Element.class));
    Bold parent2 = new Bold(parent);
    CardHeader cardHeader = new CardHeader(parent2, FormatEnum.MESSAGEML);
    MessageMLParser parser = mock(MessageMLParser.class);

    // Act and Assert
    assertThrows(
        InvalidInputException.class,
        () -> cardHeader.buildAttribute(parser, new IIOMetadataNode()));
  }

  /**
   * Test {@link CardHeader#asPresentationML(XmlPrintStream, MessageMLContext)}.
   *
   * <p>Method under test: {@link CardHeader#asPresentationML(XmlPrintStream, MessageMLContext)}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testAsPresentationML() {
    ...
    cardHeader.addChild(new Bold(parent3));
  ...
  public void testAsPresentationML5() {
    ...
    cardHeader.addChild(new Checkbox(parent4, FormatEnum.MESSAGEML));
  ...
  public void testAsPresentationML6() {
    ...
    BulletList parent3 = new BulletList(mock(Element.class));
    Bold parent4 = new Bold(parent3);
    cardHeader.addChild(new Button(parent4, FormatEnum.MESSAGEML));
  ...
  public void testAsPresentationML7() {
    ...
    BulletList parent3 = new BulletList(mock(Element.class));
    Bold parent4 = new Bold(parent3);
    cardHeader.addChild(new CardBody(parent4, FormatEnum.MESSAGEML));
  ...
  public void testAsPresentationML8() {
    ...
    BulletList parent3 = new BulletList(mock(Element.class));
    Bold parent4 = new Bold(parent3);
    cardHeader.addChild(new CardHeader(parent4, FormatEnum.MESSAGEML));
  ...
  public void testAsPresentationML9() {
    ...
    CardHeader cardHeader = new CardHeader(parent4, FormatEnum.MESSAGEML);
  ...
  public void testAsPresentationML10() {
    ...
    BulletList parent3 = new BulletList(mock(Element.class));
    Bold parent4 = new Bold(parent3);
    cardHeader.addChild(new CashTag(parent4, 1));
  ...
  public void testAsPresentationML12() {
    ...
    CardHeader cardHeader = new CardHeader(parent5, FormatEnum.MESSAGEML);
    cardHeader.addChild(child);
   ...
   *
   * <p>Method under test: {@link CardHeader#asMarkdown()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  ...
  public void testAsMarkdown() {
    ...
    // Act
    Node actualAsMarkdownResult = new CardHeader(parent2, FormatEnum.MESSAGEML).asMarkdown();
   ...
   * </ul>
   *
   * <p>Method under test: {@link CardHeader#validate()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"void CardHeader.validate()"})
  public void testValidate_givenCardWithParentIsBoldAndFormatIsMessageml_thenDoesNotThrow()
    ...
    // Act and Assert
    new CardHeader(parent2, FormatEnum.MESSAGEML).validate();
  }
  ...
  public void testValidate_thenThrowInvalidInputException() throws InvalidInputException {
    ...
    // Act and Assert
    assertThrows(
        InvalidInputException.class, () -> new CardHeader(parent, FormatEnum.MESSAGEML).validate());
  }
}
